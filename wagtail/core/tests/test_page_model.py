...
class TestCopyPage(TestCase):
    ...
    def test_copy_page_does_not_copy_comments(self):
        ...
        christmas_event.wagtail_comments = [Comment(text='test', user=christmas_event.owner)]
        christmas_event.save()
        ...
        self.assertEqual(christmas_event.wagtail_comments.count(), 1, "Comments were removed from the original page")

        # Check that comments were NOT copied over
        self.assertFalse(
            new_christmas_event.wagtail_comments.exists(),
